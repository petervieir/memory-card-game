...
export const DIFFICULTIES: Record<string, Difficulty> = {
  beginner: {
    ...
    maxMovesForBonus: 12,
    maxHints: 3,
    description: '6 trios - Perfect for beginners',
    emoji: '😊',
    timerSeconds: 60
  },
  easy: {
    ...
    maxMovesForBonus: 16,
    maxHints: 3,
    description: '8 trios - Getting comfortable',
    emoji: '🙂',
    timerSeconds: 90
  },
  medium: {
    ...
    maxMovesForBonus: 20,
    maxHints: 2,
    description: '10 trios - A moderate challenge',
    emoji: '🤔',
    timerSeconds: 100
  },
  hard: {
    ...
    maxMovesForBonus: 24,
    maxHints: 2,
    description: '12 trios - For experienced players',
    emoji: '😤',
    timerSeconds: 110
  },
  expert: {
    ...
    maxMovesForBonus: 28,
    maxHints: 1,
    description: '14 trios - Ultimate memory test',
    emoji: '🧠',
    timerSeconds: 120
  },
  master: {
    ...
    maxMovesForBonus: 32,
    maxHints: 1,
    description: '16 trios - Legendary challenge',
    emoji: '🏆',
    timerSeconds: 120
  }
};
